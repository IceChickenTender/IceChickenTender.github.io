...
이 문제는 [Baekjoon 의 9663번](https://www.acmicpc.net/problem/9663) 문제입니다. Baekjoon 사이트의 정책상 문제의 저작권은 문제를 만든 사람에게 있기 때문에 블로그에 문제 내용을 적는 것 보다는 링크로 문제의 내용을 확인할 수 있게 하라고 되어 있습니다. 그러므로 문제의 자세한 내용은 링크를 통해 사이트를 방문하여 확인해 주시길 바랍니다.
